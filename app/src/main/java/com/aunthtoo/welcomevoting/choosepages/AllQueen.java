...
public class AllQueen extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.allqueen);

        toolbar=(Toolbar)findViewById(R.id.tballqueen);
        ...
        getSupportActionBar().setTitle("All Queen");

        //db testing
        girlDBHandler = new GirlDBHandler(AllQueen.this);
        selectionList = girlDBHandler.getAllQueen();

        r=(RelativeLayout)findViewById(R.id.rel);

        rcv=(RecyclerView)findViewById(R.id.recycler_viewking);
        adapter=new SelectionAdapter(AllQueen.this,selectionList,r,10);

        RecyclerView.LayoutManager rl=new LinearLayoutManager(AllQueen.this);
