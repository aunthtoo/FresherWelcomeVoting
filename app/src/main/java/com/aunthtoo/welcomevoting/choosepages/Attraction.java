...
public class Attraction extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar=(Toolbar)findViewById(R.id.tbattraction);
        ...
        //db testing
        girlDBHandler = new GirlDBHandler(Attraction.this);
        selectionList = girlDBHandler.getAttraction();

        r=(RelativeLayout)findViewById(R.id.rel);

        rcv=(RecyclerView)findViewById(R.id.recycler_viewking);
        adapter=new SelectionAdapter(Attraction.this,selectionList,r,8);

        RecyclerView.LayoutManager rl=new LinearLayoutManager(Attraction.this);
