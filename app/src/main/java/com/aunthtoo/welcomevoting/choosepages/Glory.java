...
public class Glory extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.glory);

        toolbar=(Toolbar)findViewById(R.id.tbglory);
        ...
        getSupportActionBar().setTitle("Glory");

        //db testing
        girlDBHandler = new GirlDBHandler(Glory.this);
        selectionList = girlDBHandler.getGlory();

        r=(RelativeLayout)findViewById(R.id.rel);

        rcv=(RecyclerView)findViewById(R.id.recycler_viewking);
        adapter=new SelectionAdapter(Glory.this,selectionList,r,7);

        RecyclerView.LayoutManager rl=new LinearLayoutManager(Glory.this);
