...
public class Popular extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = (Toolbar) findViewById(R.id.tbpopular);
        ...
        //db testing
        boyDBHandler = new BoyDBHandler(Popular.this);
        selectionList = boyDBHandler.getPopular();

        r = (RelativeLayout) findViewById(R.id.rel);

        rcv = (RecyclerView) findViewById(R.id.recycler_viewking);
        adapter = new SelectionAdapter(Popular.this, selectionList, r, 3);

        RecyclerView.LayoutManager rl = new LinearLayoutManager(Popular.this);
