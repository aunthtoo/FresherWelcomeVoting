...
public class Queen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar=(Toolbar)findViewById(R.id.tbqueen);
        ...
        getSupportActionBar().setTitle("Queen");

        //db testing
        girlDBHandler = new GirlDBHandler(Queen.this);
        selectionList = girlDBHandler.getQueen();

        r=(RelativeLayout)findViewById(R.id.rel);

        rcv=(RecyclerView)findViewById(R.id.recycler_viewking);
        adapter=new SelectionAdapter(Queen.this,selectionList,r,6);

        RecyclerView.LayoutManager rl=new LinearLayoutManager(Queen.this);
