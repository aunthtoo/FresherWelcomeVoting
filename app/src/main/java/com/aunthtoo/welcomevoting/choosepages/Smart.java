...
public class Smart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = (Toolbar) findViewById(R.id.tbsmart);
        ...
        //db testing
        boyDBHandler = new BoyDBHandler(Smart.this);
        selectionList = boyDBHandler.getSmart();

        r = (RelativeLayout) findViewById(R.id.rel);

        rcv = (RecyclerView) findViewById(R.id.recycler_viewking);
        adapter = new SelectionAdapter(Smart.this, selectionList, r, 2);

        RecyclerView.LayoutManager rl = new LinearLayoutManager(Smart.this);
